# invoice-processing-toolkit

OCR and LLM extraction with PO matching, approval routing, and exception flagging.
...
pip install -e .
python -m invoice_processing_toolkit.cli --help
python -m unittest discover -s tests -v
```

## Project structure
- `src/invoice_processing_toolkit/`: production code
